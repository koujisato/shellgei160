...
|-----|--------------------|-------------|----------------|----------|----------|
|p.428 |解答をつくっていくなかのgrepのオプション（4箇所）|grep -zoP|grep -zoE|[issue52](https://github.com/shellgei/shellgei160/issues/52)|PCREだと改行が.（ドット）にマッチしないので本文では「念のため」となっているけど念のためになっていなかった。（ebanさんから教えてもらった。）|
